...
<div class="form-n5">
    ...
    <input type="text" name="email" id="email" value='<?= esc(get_cookie("email")); ?>' required placeholder="Ex: name@sample.com">
    <div class="form-nav-btn-div">
        <div>
        <button class="prev-button-n2"><a href="/osc/create/4">Précédent</a></button>
