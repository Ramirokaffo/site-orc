...
<?= form_open("osc/create/2/$oscId/0") ?>
...
<div class="form-n2">
    ...
    <input type="tel" name="phoneNumber1" value='<?= esc(get_cookie("phoneNumber1")); ?>' required id="phoneNumber1" placeholder="+0000 000 000 000">
    <h6>Numero de téléphone 2</h6>
    <input type="tel" name="phoneNumber2" value='<?= esc(get_cookie("phoneNumber2")); ?>' id="phoneNumber2" placeholder="+0000 000 000 000">
    <h6>Lien du site Web</h6>
    <input type="text" name="webSite" value='<?= esc(get_cookie("webSite")); ?>' id="webSite" placeholder="Ex: www.acje.org">
    <h6>Adresse mail</h6>
    <input type="email" name="oscEmail" value='<?= esc(get_cookie("oscEmail")); ?>' id="oscEmail" placeholder="Ex: name.@gmail.com">
    <div class="form-nav-btn-div">
        <div>
        <!-- <a href="javascript:history.go(-1);" class="prev-button-n2">Précédent -->
            <!-- </a> -->
            <button class="prev-button-n2"><a href="/osc/create/1/<?= esc($oscId) ?>/1">Précédent</a></button>
